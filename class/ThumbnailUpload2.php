...
require_once 'Thumbnail2.php';
// "thumb" here represents anything that's smaller than the original
class ThumbnailUpload2 extends Upload {
	...
	protected function createThumbnail($image) {
		$thumb = new Thumbnail2($image, $this->thumbDestination, $this->maxSize, $this->suffix)	;
		$thumb->create();
	...
	protected function moveFile($file) {
        ...
        if ($success) {
        		// add a message only if the original image is not delted
